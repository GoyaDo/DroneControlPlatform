package com.ysmjjsy.goya.drone.dji.sdk.config;

import com.ysmjjsy.goya.drone.dji.sdk.annotations.CloudSDKVersion;
import com.ysmjjsy.goya.drone.dji.sdk.common.*;
import com.ysmjjsy.goya.drone.dji.sdk.config.version.GatewayManager;
import com.ysmjjsy.goya.drone.dji.sdk.exception.CloudSDKErrorEnum;
import com.ysmjjsy.goya.drone.dji.sdk.exception.CloudSDKException;
...
public class CloudSDKHandler {
    ...
    @Before("execution(public * com.ysmjjsy.goya.drone.dji.sdk.cloudapi.*.api.*.*(com.ysmjjsy.goya.drone.dji.sdk.config.version.GatewayManager, ..))")
    ...
    @Before("execution(public * com.ysmjjsy.goya.drone.dji.sdk.cloudapi.*.api.*.*(com.ysmjjsy.goya.drone.dji.sdk.config.version.GatewayManager, com.ysmjjsy.goya.drone.dji.sdk.common.BaseModel+))")
    public void checkRequest(JoinPoint point) {
        Common.validateModel((BaseModel) point.getArgs()[1], (GatewayManager) point.getArgs()[0]);
    }

    @AfterReturning(value = "execution(public com.ysmjjsy.goya.drone.dji.sdk.common.HttpResultResponse+ com.ysmjjsy.goya.drone.dji.sdk.cloudapi.*.api.*.*(..))", returning = "response")
